...
generating_models_prediction=PythonOperator(task_id='generating_models_prediction',dag=Lead_scoring_inference_dag,python_callable=utils.get_models_prediction,op_kwargs={'db_file_name':constants.DB_FILE_NAME,'db_path':constants.DB_PATH,'tracking_uri':constants.ML_FLOW_TRACKING_URI,'model_path':constants.MODEL_PATH})
