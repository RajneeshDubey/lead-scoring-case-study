...
def get_models_prediction(db_file_name,db_path,model_path,tracking_uri):
    '''
...
def prediction_ratio_check(db_file_name,db_path,file_path):
    ...
    ct = datetime.now()
    text = str(ct) +" % of 1="+str(per_value[0])+ " % of 0 =" + str(1.0 - per_value[0])
